...
let firstThing = 5;
let secondThing = 6;
if (firstThing < secondThing) console.log(firstThing);
...
if (computerChoice < 0.5) computerChoice = "rock";
...
function grade(score){
  ...
  else if (score >= 80 && score <= 89) return 'you got a B';
